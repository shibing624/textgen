...
def main():
    ...
    parser.add_argument('--model_type', default='baichuan', type=str, help='Transformers model type')
    parser.add_argument('--model_name', default='baichuan-inc/baichuan-7B', type=str,
    ...
    parser.add_argument('--output_dir', default='./outputs-baichuan-mydata/', type=str, help='Model output directory')
