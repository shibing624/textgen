...
parser.add_argument('--model_type', default='chatglm', type=str)
parser.add_argument('--base_model', default='THUDM/chatglm2-6b', type=str)
...
print(args)
model = ChatGlmModel(args.model_type, args.base_model, peft_name=args.lora_model)
sents = [
    "失眠怎么办？",
    '用一句话描述地球为什么是独一无二的。',
