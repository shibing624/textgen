...
sys.path.append('..')
from textgen.seq2seq.data_reader import gen_examples, read_vocab, create_dataset, one_hot, save_word_dict, load_word_dict
from textgen.seq2seq.seq2seq import Seq2Seq, LanguageModelCriterion
from textgen.seq2seq.data_reader import PAD_TOKEN
from textgen.seq2seq.convseq2seq import ConvSeq2Seq
