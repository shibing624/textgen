...
from textgen.custom_models.models import CopyT5ForConditionalGeneration
from textgen.config.model_args import CopyT5Args
from textgen.t5.copyt5_utils import CopyT5Dataset, load_hf_dataset, copy_loss, ZHTokenizer
...
class CopyT5Model:
    def __init__(
        ...
        """
        Initializes a CopyT5Model model.

        Args:
            model_type: The type of model (copyt5)
        ...
        elif isinstance(args, CopyT5Args):
            self.args = args
    ...
    def train(
        ...
        for current_epoch in train_iterator:
            ...
            for step, batch in enumerate(batch_iterator):
                ...
                labels = batch[2]
                loss = copy_loss(outputs.logits, labels, attention_mask)
                if args.n_gpu > 1:
                    loss = (
                        loss.mean()
